...
},{"../es":"node_modules/core-js/es/index.js","../web":"node_modules/core-js/web/index.js","../internals/path":"node_modules/core-js/internals/path.js"}],"js/script.js":[function(require,module,exports) {
"use strict";
...
var hamBtnIcon = document.querySelector(".nav__ham-btn").firstElementChild;
var brand = document.querySelector(".nav__brand");
var searchBtn = document.querySelector(".nav__search-btn");
var searchBtnIcon = document.querySelector(".nav__search-btn").firstElementChild;
var searchBar = document.querySelector(".nav__search");
var searchTxt = document.querySelector(".nav__search__text");
var sliderContainer = document.querySelector(".slider");
var main = document.querySelector("main");
var footer = document.querySelector("footer");
var tabs = document.querySelectorAll(".block__tab");
var tabsContainer = document.querySelectorAll(".block__tab-container");
var tabsContent = document.querySelectorAll(".block__content"); ////////////////////////////////////////////////////////
// Reveal Sections When Scrolling
////////////////////////////////////////////////////////

var allSec = document.querySelectorAll("section");

var revealSec = function revealSec(entries, observer) {
...
var secObserver = new IntersectionObserver(revealSec, {
  root: null,
  threshold: 0.15
});
...
document.addEventListener("click", function (ev) {
  if (!ev.target.closest(".nav__menu") && hamBtnIcon.classList.contains("fa-times") && !ev.target.closest(".nav__ham-btn")) {
    showNav();
  } else if (!ev.target.closest(".search") && searchBtnIcon.classList.contains("fa-times") && !ev.target.closest(".nav__search-btn") && ev.target !== searchTxt) {
    showSearch();
  }
}); ////////////////////////////////////////////////////////
// Slider
...
var slider = function slider() {
  ...
  sliderContainer.addEventListener("touchstart", function (e) {
    return touchstartX = e.changedTouches[0].screenX;
  });
...
tabsContainer.forEach(function (tabsBox) {
  tabsBox.addEventListener("click", function (e) {
    var clicked = e.target.closest(".block__tab");
    var clickedContent = document.querySelector(".block__content--".concat(clicked.dataset.tab));
    var tabContentSiblings = Array.from(document.querySelector(".block__content--".concat(clicked.dataset.tab)).parentNode.children).slice(2);
    var tabSiblings = Array.from(e.target.parentNode.children);
    if (!clicked) return;
    tabSiblings.forEach(function (tb) {
      return tb.classList.remove("block__tab--active");
    });
    tabContentSiblings.forEach(function (cnt) {
      return cnt.classList.remove("block__content--active");
    });
